...
class OSSTaskHandler(FileTaskHandler, LoggingMixin):
    ...
    def hook(self):
        ...
        try:
            from airflow.hooks.oss_hook import OSSHook
            return OSSHook(remote_conn_id, self.remote_base)
    ...
    def oss_log_exists(self, remote_log_location):
        ...
        """
        try:
            return self.hook.key_exist(remote_log_location)
        except Exception:
            pass
        return False
    ...
    def oss_read(self, remote_log_location, return_error=False):
        ...
        """
        try:
            self.log.info("read remote log: " + remote_log_location)
    ...
    def oss_write(self, log, remote_log_location, append=True):
        ...
        try:
            self.log.info("writing remote log: " + remote_log_location)
